...
function rightSideContent(result) {
  return `<div class="content">
        ...
        <div class="content">
          ...
          <span class="value">${Math.round(result.main.temp - 275.15)}
...
async function displayForeCast(lat, long) {
  const ForeCast_API = `https://api.openweathermap.org/data/2.5/forecast?lat={lat}&lon={long}&exclude={part}&appid={API key}`;
